...
<body>
	...
	<header class="main-header" >
		...
		<nav>
			...
			<a class="letra" href="login.php">Login </a>
				
		</nav>
	</header>

	<section class="banner">
	<img src="vista/img/header.jpg" alt="" class="banner__img">
</section>
	...
	<section class=" group main__about__description">
		<div class="container container--flex">
			<div class="column column--50">
				<img class="img" src="vista/img/studio.jpg" alt="">
			</div>
			<div class="column column--50">
		...
		<div class="container container--flex">
			...
			<div class="column column--50">
				<img class="img" src="vista/img/lentes.jpg" alt="">
			</div>
		</div>
		<div class="marquee">
		...
		<section class="gallery" id="galeria">
					<img src="vista/img/informatica.jpg" class="img-galeria" alt="">
					<img src="vista/img/meca.jpg" class="img-galeria" alt=""> 
					<img src="vista/img/electronica.jpg" class="img-galeria" alt="">
					<img src="vista/img/pro.jpg" class="img-galeria" alt="">
					<img src="vista/img/civil.jpg" class="img-galeria" alt="">
					<img src="vista/img/agro.png" class="img-galeria" alt="">
					<img src="vista/img/electri.jpg" class="img-galeria" alt="">
					<img src="vista/img/sturio2.jpg" class="img-galeria" alt="">
		</section>
			...
			<table class="pre-footer">
				...
				<tr>
					<td><img src="vista/img/equipo3.jpg" alt=""></td>
					<td><img src="vista/img/equipo.jpg" alt=""></td>
					<td><img src="vista/img/seguridad.jpg" alt=""></td>
				</tr>
				<tr>
